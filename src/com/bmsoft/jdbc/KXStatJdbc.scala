...
/**
 * KX insert into oracle
 * @author mathsyang
 */
class KXStatJdbc {
  def insertRunStat(df: DataFrame, statDate: String, statCycle: String): Unit = {
    val tableName = DateFormatUtil.tableName("PWYW_KXYXZTTJ", statCycle)
    val errTableName = DateFormatUtil.tableName("ERR_PWYW_KXYXZTTJ", statCycle)

    val tjrq = if (DateFormatUtil.STAT_CYCLE_WEEK.equals(statCycle)) "TJKSRQ,TJJSRQ\n" else "TJRQ\n"
    ...
    df.foreachPartition(row => {
      ...
      try {
        ...
        row.foreach(data => {
          iCnt += 1
          var index = 1
          OracleUtils.ExecPS(data, ps, index, "XLID", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "XLMC", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "YXBH", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "DYDJ", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "SSDS", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "YWDW", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "YWDWMC", java.sql.Types.VARCHAR); index += 1
          ...
          OracleUtils.ExecPS(data, ps, index, "SSDZ", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "CNW", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "ZXID", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "SSZX", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "XLXZ", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "ZYCD", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "QDDZ", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "ZDDZ", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "TYRQ", java.sql.Types.TIMESTAMP); index += 1
          OracleUtils.ExecPS(data, ps, index, "JSFS", java.sql.Types.VARCHAR); index += 1
          OracleUtils.ExecPS(data, ps, index, "ZDYXDL", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "JJDL", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "YXFHXE", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "EDSSGL", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "XLZCD", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "JKXLCD", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "DLXLCD", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "JKJXFS", java.sql.Types.VARCHAR); index += 1
      ...
      df.foreachPartition(row => {
        ...
        try {
          ...
          row.foreach(data => {
            ...
            OracleUtils.ExecPS(data, ps, index, "SSDZ", java.sql.Types.VARCHAR); index += 1
            OracleUtils.ExecPS(data, ps, index, "CNW", java.sql.Types.VARCHAR); index += 1
            OracleUtils.ExecPS(data, ps, index, "ZXID", java.sql.Types.NUMERIC); index += 1
            OracleUtils.ExecPS(data, ps, index, "SSZX", java.sql.Types.VARCHAR); index += 1
            OracleUtils.ExecPS(data, ps, index, "XLXZ", java.sql.Types.VARCHAR); index += 1
            OracleUtils.ExecPS(data, ps, index, "ZYCD", java.sql.Types.VARCHAR); index += 1
            OracleUtils.ExecPS(data, ps, index, "QDDZ", java.sql.Types.VARCHAR); index += 1
  ...
  def insertSSKXExcept(df: DataFrame, statDate: String, statCycle: String): Unit = {
    val tableName = DateFormatUtil.tableName("PWYW_DWKXTJ_SS", statCycle)
    val errTableName = DateFormatUtil.tableName("ERR_PWYW_DWKXTJ_SS", statCycle)
    ...
    val sql =
      s"INSERT INTO ${tableName}\n" +
        s"(DWBM,DWJB,XLXZ,CNW,${tjrq},PMSKXSL,YCFGKXSL,CJKXSL,GDYTS,GDYZB,GDYCS,GDYSC,DDYTS,DDYZB,DDYCS,DDYSC,DLSXBPHTS,DLSXBPHZB,DLSXBPHCS,DLSXBPHSC,GZTS,GZZB,GZCS,GZSC,GLYSYCTS,GLYSYCZB,GLYSYCCS,GLYSYCSC,DYSXBPHTS,DYSXBPHZB,DYSXBPHCS,DYSXBPHSC,AGZTS,AGZZB,AGZCS,AGZSC,BGZTS,BGZZB,BGZCS,BGZSC,CGZTS,CGZZB,CGZCS,CGZSC,AZZTS,AZZZB,AZZCS,AZZSC,BZZTS,BZZZB,BZZCS,BZZSC,CZZTS,CZZZB,CZZCS,CZZSC,ZZTS,ZZZB,ZZCS,ZZSC,QZTS,QZZB,QZCS,QZSC,DYYCTS,DYYCZB,FZYCTS,FZYCZB,FZL1TS,FZL2TS,FZL3TS,FZL4TS)\n" +
    ...
    df.foreachPartition(row => {
      ...
      try {
        ...
        row.foreach(data => {
          ...
          OracleUtils.ExecPS(data, ps, index, "PMSKXSL", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "YCFGKXSL", java.sql.Types.NUMERIC); index += 1
          OracleUtils.ExecPS(data, ps, index, "CJKXSL", java.sql.Types.NUMERIC); index += 1
  ...
  def insertBZKXExcept(df: DataFrame, statDate: String, statCycle: String): Unit = {
    val tableName = DateFormatUtil.tableName("PWYW_DWKXTJ_BZ", statCycle)
    val errTableName = DateFormatUtil.tableName("ERR_PWYW_DWKXTJ_BZ", statCycle)
  ...
  def insertKXSSGatherSucc(df: DataFrame, statDate: String, statCycle: String): Unit = {
    val tableName = DateFormatUtil.tableName("PWYW_DWKXQXCJWZLTJ_SS", statCycle)
    val errTableName = DateFormatUtil.tableName("ERR_PWYW_DWKXQXCJWZLTJ_SS", statCycle)
    ...
    val sql =
      s"INSERT INTO ${tableName}\n" +
        s"(DWBM,DWJB,XLXZ,CNW,PMSKXSL,YCFGKXSL,CJKXSL,${tjrq},AXDYQXYCDS,AXDYQXSCDS,BXDYQXYCDS,BXDYQXSCDS,CXDYQXYCDS,CXDYQXSCDS,AXDLQXYCDS,AXDLQXSCDS,BXDLQXYCDS,BXDLQXSCDS,CXDLQXYCDS,CXDLQXSCDS,YGZGLQXYCDS,YGZGLQXSCDS,WGZGLQXYCDS,WGZGLQXSCDS,GLYSQXYCDS,GLYSQXSCDS)\n" +
        s"VALUES  (?,?,?,?,?,?,?,${tjrqParam},?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)  " //log errors into ${errTableName}('TEST')"
  ...
  def insertKXBZGatherSucc(df: DataFrame, statDate: String, statCycle: String): Unit = {
    val tableName = DateFormatUtil.tableName("PWYW_DWKXQXCJWZLTJ_BZ", statCycle)
    val errTableName = DateFormatUtil.tableName("ERR_PWYW_DWKXQXCJWZLTJ_BZ", statCycle)
  ...
  def insertKXSSClass(df: DataFrame, statDate: String, statCycle: String): Unit = {
    val tableName = DateFormatUtil.tableName("PWYW_DWKXSJFJTJ", statCycle)
    val errTableName = DateFormatUtil.tableName("ERR_PWYW_DWKXSJFJTJ", statCycle)
    ...
    val sql =
      s"INSERT INTO ${tableName}\n" +
        s"(DWBM,DWMC,DWJB,SJDWBM,SJDWMC,CNW,XLXZ,EDRLDJ,${tjrq},GJBM,SJDJ,PMSKXSL,CJKXSL,GZTS,GZZB,GZCS,GZSC)\n" +
        s"VALUES  (${tjrqParam},?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)  " //log errors into ${errTableName}('TEST')"
